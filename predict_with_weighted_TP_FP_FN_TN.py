...
DISEASE_LIST =[
    ...
    "no abnormality","no findings","no abnormalities"
]
# 疾病提取函数 
...
#  加载模型和评估 
def load_model_with_lora(base_model_path, lora_path, dtype=torch.float16):
...
if __name__ == "__main__":
    ...
    lora_path = "./output/Qwen2-VL-2B-LatexOCR_weighted_2_350_bias_ep6_test_more_prompt/checkpoint-1680"
    val_json_path = "./latex_ocr_val.json"
    output_dir = "./output/Qwen2-VL-2B-LatexOCR_weighted_2_350_bias_ep6_test_more_prompt"
